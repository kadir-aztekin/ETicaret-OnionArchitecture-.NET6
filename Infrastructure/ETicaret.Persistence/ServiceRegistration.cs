...
namespace ETicaret.Persistence
{
    public static class ServiceRegistration //VERİTABANINA BAGLANMA YERI
    {
        public static void AddPersistenceServices(this IServiceCollection service)
        {
            ...
            service.AddDbContext<ETicaretDbContext>(options => options.UseNpgsql("User ID=postgres;Password=1234;Host=localhost;Port=5432;Database=ETicaretDb;"),ServiceLifetime.Singleton);
